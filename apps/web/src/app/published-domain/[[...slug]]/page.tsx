...
export default async function PublishedByDomainPage({
  params,
}: {
  ...
  const response = await fetch(`${API_BASE_URL}/published/by-domain/${encodeURIComponent(host)}`, {
    cache: "no-store",
  });
  ...
  return (
    <>
      ...
      <a
        href="https://studio.forgestackx.com"
        target="_blank"
        rel="noreferrer"
